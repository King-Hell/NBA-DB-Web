...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"><a class="navbar-brand" href="#"><img alt="NBA标志"
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a class="nav-link" href="coach-index.php">教练</a>
            </li>
        ...
        <div class="card-body">
            <table class="table table-hover table-players table-striped">
                ...
                while ($row = $result->fetch_row()) {
                    echo "<tr>";
                    echo "<td><img alt='头像' class='img-thumbnail' src='https://nba-1253437773.cos.ap-beijing.myqcloud.com/images/coach/$row[0].png'></td>";
